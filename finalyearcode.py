...
RUN_TOKEN="tveMTQL86Wow"

def app():
    st.title("""
Covid-19 Voice Search Done in realtime.""")
    st.write("""The data is updated on a daily baisis. The data is collected from Worldometer Coronavirus Website.""")
    st.markdown("""
This page works like your personal assistant in speaking out to you the Coronavirus Worldwide Cases.""")
    st.markdown("""For example you can ask it questions like "What is the total number of covid cases?", "What is the number of covid cases in India?", "What is number of recovered cases in Germany?", "What is the number of deaths in Canada?" etc. Finally use the phrase "stop" to exit.""")
